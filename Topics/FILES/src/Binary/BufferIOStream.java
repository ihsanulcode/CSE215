...
public class BufferIOStream {
	...
	public static void main(String[] args) throws IOException {
		...
		//Output
		DataOutputStream output = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("src/Binary/DataIO.dat")));
		...
		//Input
		DataInputStream input = new DataInputStream(new BufferedInputStream(new FileInputStream("src/Binary/DataIO.dat")));
